...
#     from tokenizer_test import read_from_file_corpus
#     return read_from_file_corpus
...
def main():
    ...
    test = tokenizer_test.read_from_file('document.txt')
    print(test[0])
    ...
    my_dict = temp_insert_corpus(my_dict, corpus_sents2)
    ...
    with open('mousecookie.json', 'w') as outfile:
