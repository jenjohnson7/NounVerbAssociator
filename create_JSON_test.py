...
# def local_import(my_dict, read_from_file_corpus):
#     """ local and delayed import to avoid circular dependencies"""
#     my_dict = temp_insert_corpus(my_dict, read_from_file_corpus)
#     return my_dict
...
def main():
    ...
    read_from_file_corpus = tokenizer_test.read_from_file()
    print(read_from_file_corpus)
    ...
    with open('create_JSON_test_data.json', 'w') as outfile:
